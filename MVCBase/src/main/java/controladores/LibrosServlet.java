...
public class LibrosServlet extends HttpServlet {
	...
	private void editar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Editorial>lista=daoEd.getListaEditorial();
	...
	private void insertarLibros(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String isbn = request.getParameter("isbn");
		String titulo = request.getParameter("titulo");
		int codEditorial=Integer.parseInt(request.getParameter("codEditorial"));
		int año=Integer.parseInt(request.getParameter("anio"));
